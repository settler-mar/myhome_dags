...
const ptvo_switch = zigbeeHerdsmanConverters.findByDevice({modelID: 'ptvo.uart'});
...
const device = {
    zigbeeModel: ['ptvo.uart3'],
    model: 'ptvo.uart3',
    vendor: 'ptvo.my',
    description: '[Configurable firmware](https://ptvo.info/zigbee-configurable-firmware-features/)',
    fromZigbee: [fz.ignore_basic_report, fz.ptvo_switch_uart, fz.ptvo_on_off, fz.ptvo_on_off_config, fz.ptvo_multistate_action, fz.legacy.ptvo_switch_buttons,],
    toZigbee: [tz.ptvo_switch_trigger, tz.ptvo_switch_uart, tz.on_off, tz.ptvo_on_off_config,],
    ...
    endpoint: (device) => {
        return {
            l1: 1, action: 1, l2: 2, l3: 3, l4: 4, l6: 6, l7: 7, l8: 8, l5: 5,
        };
    },
